...
namespace API.Migrations
{
    ...
    [Migration("20240624224221_AddStatusToTarefa")]
    partial class AddStatusToTarefa
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("API.Models.Categoria", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CriadoEm = new DateTime(2024, 6, 25, 19, 42, 20, 374, DateTimeKind.Local).AddTicks(3166),
                            Nome = "Trabalho"
                        },
                        new
                        {
                            CategoriaId = "6d091456-5a2f-4b5a-98fc-f1a3b50a627d",
                            CriadoEm = new DateTime(2024, 6, 26, 19, 42, 20, 374, DateTimeKind.Local).AddTicks(3175),
                            Nome = "Estudos"
                        },
                        new
                        {
                            CategoriaId = "39be53a2-fc09-4b6a-bafa-18a6a23c8f6e",
                            CriadoEm = new DateTime(2024, 6, 27, 19, 42, 20, 374, DateTimeKind.Local).AddTicks(3178),
                            Nome = "Lazer"
                        });
                });
            ...
            modelBuilder.Entity("API.Models.Tarefa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoriaId = "bfe4e7dc-81e4-4e47-a67b-d4fbf3e124bd",
                            CriadoEm = new DateTime(2024, 7, 1, 19, 42, 20, 374, DateTimeKind.Local).AddTicks(3336),
                        ...
                        new
                        {
                            ...
                            CategoriaId = "6d091456-5a2f-4b5a-98fc-f1a3b50a627d",
                            CriadoEm = new DateTime(2024, 6, 27, 19, 42, 20, 374, DateTimeKind.Local).AddTicks(3342),
                        ...
                        new
                        {
                            ...
                            CategoriaId = "39be53a2-fc09-4b6a-bafa-18a6a23c8f6e",
                            CriadoEm = new DateTime(2024, 7, 8, 19, 42, 20, 374, DateTimeKind.Local).AddTicks(3346),
